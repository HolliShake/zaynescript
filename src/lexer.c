...
static Token TokenizeIdentifier(Lexer* lexer) {
    ...
    // Check for keywords
    const String keywords[] = { KEY_IF,     KEY_ELSE,  KEY_SWITCH,   KEY_CASE,   KEY_DEFAULT,
                                KEY_WHILE,  KEY_FOR,   KEY_DO,       KEY_TRY,    KEY_CATCH,
                                KEY_RETURN, KEY_BREAK, KEY_CONTINUE, KEY_NULL,   KEY_TRUE,
                                KEY_FALSE,  KEY_CLASS, KEY_ENUM,     KEY_IMPORT, KEY_FROM,
                                KEY_STATIC, KEY_CONST, KEY_VAR,      KEY_LOCAL,  KEY_FN,
                                KEY_ASYNC,  KEY_AWAIT, KEY_NEW,      KEY_THIS };
