...
#define KEY_STATIC                                              \
	"static"			  /**< Static member modifier keyword */
#define KEY_IMPORT "import" /**< Module import keyword */
#define KEY_FROM   "from" /**< Import source specifier keyword */
#define KEY_CONST                                               \
	"const" /**< Immutable variable declaration keyword */
#define KEY_VAR                                                 \
	"var"	/**< Mutable variable declaration keyword */
#define KEY_LOCAL                                               \
	"local" /**< Local (function-scoped) variable declaration   \
			   keyword */
#define KEY_ASYNC                                               \
	"async" /**< Asynchronous function modifier keyword */
...
#define KEY_CASE                                                \
	"case"	  /**< Case label keyword in a switch statement */
#define KEY_DEFAULT                                             \
...
#define KEY_CONTINUE                                            \
	"continue"			  /**< Loop iteration restart keyword */
#define KEY_RAISE "raise" /**< Exception throwing keyword */
#define KEY_ASSERT                                              \
	"assert" /**< Assertion keyword for runtime checks */
...
#define KEY_AWAIT                                               \
	"await" /**< Asynchronous operation awaiting keyword */
#define KEY_THIS                                                \
