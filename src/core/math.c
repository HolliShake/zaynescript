...
static ModuleFunction _MathModuleFunctions[] = {
	{ .Name		 = "abs",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathAbs,
	  .Value	 = NULL },
	{ .Name		 = "acos",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathAcos,
	  .Value	 = NULL },
	{ .Name		 = "asin",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathAsin,
	  .Value	 = NULL },
	{ .Name		 = "atan",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathAtan,
	  .Value	 = NULL },
	{ .Name		 = "atan2",
	  .Argc		 = 2,
	  .CFunction = (NativeFunctionCallback) _MathAtan2,
	  .Value	 = NULL },
	{ .Name		 = "ceil",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathCeil,
	  .Value	 = NULL },
	{ .Name		 = "cos",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathCos,
	  .Value	 = NULL },
	{ .Name		 = "cosh",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathCosh,
	  .Value	 = NULL },
	{ .Name		 = "exp",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathExp,
	  .Value	 = NULL },
	{ .Name		 = "floor",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathFloor,
	  .Value	 = NULL },
	{ .Name		 = "hypot",
	  .Argc		 = 2,
	  .CFunction = (NativeFunctionCallback) _MathHypot,
	  .Value	 = NULL },
	{ .Name		 = "log",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathLog,
	  .Value	 = NULL },
	{ .Name		 = "log10",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathLog10,
	  .Value	 = NULL },
	{ .Name		 = "max",
	  .Argc		 = 2,
	  .CFunction = (NativeFunctionCallback) _MathMax,
	  .Value	 = NULL },
	{ .Name		 = "min",
	  .Argc		 = 2,
	  .CFunction = (NativeFunctionCallback) _MathMin,
	  .Value	 = NULL },
	{ .Name		 = "pow",
	  .Argc		 = 2,
	  .CFunction = (NativeFunctionCallback) _MathPow,
	  .Value	 = NULL },
	{ .Name		 = "round",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathRound,
	  .Value	 = NULL },
	{ .Name		 = "sin",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathSin,
	  .Value	 = NULL },
	{ .Name		 = "sinh",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathSinh,
	  .Value	 = NULL },
	{ .Name		 = "sqrt",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathSqrt,
	  .Value	 = NULL },
	{ .Name		 = "tan",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathTan,
	  .Value	 = NULL },
	{ .Name		 = "tanh",
	  .Argc		 = 1,
	  .CFunction = (NativeFunctionCallback) _MathTanh,
	  .Value	 = NULL },
	{ .Name = NULL }
};
