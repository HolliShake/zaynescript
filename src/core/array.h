 ...
 *
 * Defines the interface for creating the built-in Array class
 * and loading the core Array module, which provides array
 * operations within the interpreter.
 */
 ...
 *
 * This function initializes and returns the Array class, which
 * provides array functionalities to the interpreter.
 *
...
/**
 * @brief Initializes and loads the Array module into the
 * interpreter.
 *
 * This function creates the Array module with all its built-in
 * functions and methods, making array operations available
