...
# External dependency headers (libbf, utf, mongoose) — ordered so that
...
def build_source(out_path):
    ...
    parts.append("")
    parts.append(
        "/* Expose POSIX/GNU decls (strdup, readlink, strcasecmp, …) in one TU. */"
    )
    parts.append("#ifndef _GNU_SOURCE")
    parts.append("#define _GNU_SOURCE")
    parts.append("#endif")
    parts.append("")
