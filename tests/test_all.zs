...
// raise
var raiseCaught = false;
try {
    raise "Error message";
} catch (e) {
    raiseCaught = true;
}
assert raiseCaught, "raise: caught by catch";
...
// .error fires on raise inside async
...
// Fix: Complete the truncated GCD test
